  ...
  useEffect(() => {
    ...
    if (hash && hash.includes("access_token")) {
      ...
      if (token) {
        ...
        // Clean the URL so the token isn't visible in the address bar and return to products view
  ...
  return (
    <div>
      ...
      {activeTab === "new-product" && (
        <ProductForm onSaved={() => setActiveTab("products")} />
      )}
      {activeTab === "orders" && <OrderList />}
      {activeTab === "new-order" && (
        <OrderForm onCreated={() => setActiveTab("orders")} />
      )}
